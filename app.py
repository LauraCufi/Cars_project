...
st.markdown("In the vehicle type graph vs the manufacturer, compare the different manufacturers offered and the types of vehicles available between those that are shown: suv, sedam, cup, cupe, among others.

From the graphics we can conclude that the manufacturer has the majority of offers available in a variety of vehicle types such as Ford.
The manufacturer with a small variety of Mercedes-Benz vehicles only offers “van” type vehicles.")
