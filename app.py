...
selected_model_year=df.model_year
model_year1=st.sidebar.selectbox('Model year',list(range(1908,2019)))
...
df_selected_model=df[(df.model_year.isin(model_year1)) & (df.model.isin(selected_model)) & (df.condition.isin(selected_contidion))]
